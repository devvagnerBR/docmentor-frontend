...
export const DashBoard = () => {
    ...
    const freezeScreen = newReport.state || updateParent.state || updateStudent.state || deleteStudent.state || newParent.state || newStudent.state
    useFreezeScreen( freezeScreen )

    return (
        <div className=" max-w-[1920px] w-full flex ">
            <SidebarMenu />
            <div className={`flex max-sm:pl-2 ${newStudent.state && "max-md:pl-2"} pl-24 w-full  max-sm:pr-2 pr-4`}>
                <Routes>
