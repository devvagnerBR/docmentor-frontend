...
export const SidebarMenu = () => {
    ...
    return (
        <div className='min-w-[4rem] max-sm:hidden bg-white ml-4 rounded-md border-neutral-900 border  h-[calc(100%-6rem)] gap-8  flex flex-col items-center pt-0 py-4 justify-start absolute  '>
